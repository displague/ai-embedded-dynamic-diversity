...
- [ ] Add CI check for agent continuity assets drift (`AGENTS.md`, `.agents/subagent-*`, skill indexes, mirror adapters).
- [ ] Add lightweight script to diff canonical role contracts vs `.claude/.opencode` mirrors and flag divergence.
- [ ] Add compact "reference subset generator" for handoff packets based on scenario tags and current task.
